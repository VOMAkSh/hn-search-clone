...
export class SearchHeader extends Component {
  ...
  onSearchQuery = () => {
    const userRef = db.collection("users").where("email",'==' , this.props.userEmail);
      userRef.get().then(querySnapshot => {
        querySnapshot.forEach(doc => {
      ...
      <Fragment>
        <div class="navbar-fixed">
          ...
          >
            ...
            <img src="https://hn.algolia.com/assets/logo-hn-search.png" className="left" style={{
              height: "50px",
            ...
            >
              ...
              >
                <input
                  ...
                  value={queryString}
                />
                <button class="btn waves-effect waves-light yellow darken-3" onClick={this.onSearchQuery} style={{
                  height: "44px",
                  marginTop: '-3px'
                }}>
